if (!Hooks._hooks.updateCombat.filterIndex(f=>f.toString().includes('CharacterDialogOnTurnHook'))[0]) {
  ...
  Hooks._hooks.updateCombat.splice(Hooks._hooks.updateCombat.filterIndex(f=>f.toString().includes('CharacterDialogOnTurnHook'))[0], 1)
